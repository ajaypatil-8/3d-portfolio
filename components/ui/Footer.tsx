...
function BackToTop() {
  ...
  return (
    <motion.button
      ...
      className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-full flex items-center justify-center cursor-hover overflow-hidden flex-shrink-0"
...
export default function Footer() {
  ...
  return (
    ...
    >
      {/* ambient glows — hidden on mobile to save paint */}
      <div
        className="hidden sm:block absolute bottom-0 left-1/4 w-64 h-64 rounded-full blur-[100px] pointer-events-none"
        style={{ backgroundColor: 'rgba(78,205,196,0.05)' }}
      />
      <div
        className="hidden sm:block absolute bottom-0 right-1/4 w-64 h-64 rounded-full blur-[100px] pointer-events-none"
      ...
      <div style={{ borderBottom: '1px solid var(--footer-border)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs sm:text-sm text-center sm:text-left" style={{ color: 'var(--text-secondary)' }}>
          ...
          <motion.a
            ...
            className="text-xs sm:text-sm font-mono cursor-hover"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        {/*
          ...
          Tablet:  2 columns (brand + nav side-by-side)
          Desktop: 12-col grid (5 + 3 + 4)
        */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-8 sm:gap-10 mb-10 sm:mb-12">
          ...
          >
            ...
            {/* Mobile: 2 column grid for nav links to save vertical space */}
            <ul className="grid grid-cols-2 sm:grid-cols-1 gap-x-4 gap-y-2.5">
              {navLinks.map((link, i) => (
                ...
                >
                  ...
                  >
                    <span
                      className="w-0 group-hover:w-3 h-px transition-all duration-200 hidden sm:block"
                      style={{ backgroundColor: 'var(--accent)' }}
                    />
                    {link.name}
                  </a>
