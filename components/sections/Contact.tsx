...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  return (
    <section id="contact" className="relative min-h-screen py-24 bg-gradient-to-b from-primary to-secondary overflow-hidden">
      ...
      {/* CSS blobs — zero GPU */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-accent/8 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent-blue/8 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <motion.div className="text-center mb-16"
          ...
          <p className="text-accent text-sm font-mono tracking-widest uppercase mb-4">Let's work together</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" required placeholder="Recruiter Name"
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/20 focus:outline-none focus:border-accent transition-colors text-sm" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea required rows={5} placeholder="Tell me about the role or opportunity..."
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/20 focus:outline-none focus:border-accent transition-colors resize-none text-sm" />
              </div>
              <motion.button type="submit" disabled={status === 'sending'}
                className="w-full py-4 bg-gradient-to-r from-accent via-accent-blue to-accent-purple text-white rounded-xl font-semibold text-sm disabled:opacity-60 cursor-hover"
          ...
          <motion.div className="space-y-5"
            ...
            <div className="glass rounded-2xl p-6 border border-green-500/20">
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                I'm actively looking for my <span className="text-white font-semibold">first job or internship</span> in
                Java backend, Spring Boot, or full-stack development. I'm a quick learner, highly motivated,
            ...
            <div className="glass rounded-2xl p-6">
              <p className="text-white/40 text-xs font-mono uppercase tracking-widest mb-4">Quick Info</p>
            ...
            {/* Social links */}
            <div className="glass rounded-2xl p-6">
              <p className="text-white/40 text-xs font-mono uppercase tracking-widest mb-4">Find Me Online</p>
              <div className="space-y-3">
                {socials.map((s, i) => (
                  <motion.a key={s.name} href={s.href} target="_blank"
                    className="flex items-center gap-3 p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors cursor-hover group"
                    whileHover={{ x: 4 }}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-white/40 text-xs">{s.value}</div>
                    </div>
